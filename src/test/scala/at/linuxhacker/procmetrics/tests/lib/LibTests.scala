...
class Tests extends FlatSpec {
  ...
  val targetCategories = List[ProcCategory](
    ProcCategory( Pid( "963", "/usr/sbin/httpd -k start " ), "io", List[ProcValue](
      ProcValueFactory.create( "rchar", ProcFloatValue( 1024.0f ) ),
      ProcValueFactory.create( "wchar", ProcFloatValue( 0.0f ) ),
      ProcValueFactory.create( "syscr", ProcFloatValue( 3.0f ) ),
      ProcValueFactory.create( "syscw", ProcFloatValue( 0.0f ) ),
      ProcValueFactory.create( "read_bytes", ProcFloatValue( 0.0f ) ),
      ProcValueFactory.create( "write_bytes", ProcFloatValue( 0.0f ) ),
      ProcValueFactory.create( "cancelled_write_bytes", ProcFloatValue(0.0f) ) ) ),
    ProcCategory( Pid( "952", "/usr/sbin/httpd -k start " ), "io", List[ProcValue](
      ProcValueFactory.create( "rchar", ProcFloatValue( 75182.0f ) ),
      ProcValueFactory.create( "wchar", ProcFloatValue( 260.0f ) ),
      ProcValueFactory.create( "syscr", ProcFloatValue( 39.0f ) ),
      ProcValueFactory.create( "syscw", ProcFloatValue( 4.0f ) ),
      ProcValueFactory.create( "read_bytes", ProcFloatValue( 3719168.0f ) ),
      ProcValueFactory.create( "write_bytes", ProcFloatValue( 0.0f ) ),
      ProcValueFactory.create( "cancelled_write_bytes", ProcFloatValue(0.0f) ) ) ),
    ProcCategory( Pid( "952", "/usr/sbin/httpd -k start " ), "io", List[ProcValue](
      ProcValueFactory.create( "rchar", ProcFloatValue( 75182.0f ) ),
    ...
    ProcCategory( Pid( "1309", "/usr/bin/kactivitymanagerd " ), "io", List[ProcValue](
      ProcValueFactory.create( "rchar", ProcFloatValue( 722539.0f ) ),
      ProcValueFactory.create( "wchar", ProcFloatValue( 282820.0f ) ),
      ProcValueFactory.create( "syscr", ProcFloatValue( 1309.0f ) ),
      ProcValueFactory.create( "syscw", ProcFloatValue( 1755.0f ) ),
      ProcValueFactory.create( "read_bytes", ProcFloatValue( 1859584.0f ) ),
      ProcValueFactory.create( "write_bytes", ProcFloatValue( 147456.0f ) ),
      ProcValueFactory.create( "cancelled_write_bytes", ProcFloatValue(0.0f) ) ) )
  )
  ...
  val targetCategories2 = List[ProcCategory](
    ...
    ProcCategory( Pid( "961", "/usr/sbin/httpd -k start " ), "io", List[ProcValue](
      ...
      ProcValueFactory.create( "cancelled_write_bytes", ProcFloatValue(0.0f) ) ) ),
    ProcCategory( Pid( "1309", "/usr/bin/kactivitymanagerd " ), "io", List[ProcValue](
      ProcValueFactory.create( "rchar", ProcFloatValue( 722555.0f ) ),
      ProcValueFactory.create( "wchar", ProcFloatValue( 283004.0f ) ),
      ProcValueFactory.create( "syscr", ProcFloatValue( 1311.0f ) ),
      ProcValueFactory.create( "syscw", ProcFloatValue( 1764.0f ) ),
      ProcValueFactory.create( "read_bytes", ProcFloatValue( 1859584.0f ) ),
      ProcValueFactory.create( "write_bytes", ProcFloatValue( 147456.0f ) ),
      ProcValueFactory.create( "cancelled_write_bytes", ProcFloatValue(0.0f) ) ) )
  )
